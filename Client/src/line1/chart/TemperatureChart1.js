...
class TemperatureChart1 extends React.Component {
  constructor(props) {
    super(props);
    this.mine = true;
            ...
            {({ data, loading }) => {
              ...
              if(this.mine) {
                ...
                for(let i=0; i<length; i++)
                  if(data.temperatures[i].label == 1) this.mytemp.temperatures.push(data.temperatures[i]);
...
export default TemperatureChart1;